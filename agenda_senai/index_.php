...
<div class="resume">
    ...
    <h1 class="page-title">COLABORADOR DO SENAI</h1>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="col-xs-12 col-sm-8">
              <ul class="list-group">
                <li class="list-group-item">Joanes</li>
                <li class="list-group-item">DTI</li>
                <li class="list-group-item">Senai Pernambuco </li>
                <li class="list-group-item"><i class="fa fa-phone"></i> 000-000-0000</li>				
                <li class="list-group-item"><i class="fa fa-ramal"></i> Ramal: 0000</li>
                <li class="list-group-item"><i class="fa fa-envelope"></i> senai@pe.senai.br</li>
              </ul>
            </div>
          </div>
        </div>
